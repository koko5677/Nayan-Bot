...
module.exports.run = async function({ api, event, Users }) {
  ...
  if (event.logMessageData.addedParticipants && Array.isArray(event.logMessageData.addedParticipants) && event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    let gifUrl = 'https://i.postimg.cc/90wCpz71/20250112-164939.png';
...
.then(response => {
  ...
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    ...
    return api.sendMessage("OWNER SK WITH DIL ROOBA.🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
DEVELOPER :SK OFFICIAL INSIDE 

🟣Facebook Account Link: 

https://www.facebook.com/www.KOKOOFFICIAL0056

🔵WHATSAPP NUMBER: NI MILAGA 🤣🤣

🟢SUPPORT EMAIL: www.tiktoker91@gmail.com`, attachment: fs.createReadStream(gifPath)}, threadID));
  }})
.catch(error => {
    console.error(error);
});
    ...
    try {
      ...
      for (let o = 0; o < event.logMessageData.addedParticipants.length; o++) {
        ...
        var ok = [
          'https://i.imgur.com/pNcckro.png',
          'https://i.imgur.com/5uxMVam.png',
          'https://i.imgur.com/CKG2Oj7.png',
          'https://i.imgur.com/GsoQLAM.png',
          'https://i.imgur.com/wcH5Iq8.png'
        ]
